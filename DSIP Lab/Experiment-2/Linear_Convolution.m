% == == == == == == == == == == == == == == == == == == == == == == == == == ==
    ...
    : %
      This program demonstrates Linear Convolution of two discrete
           ...
           -
           Invariant(LTI) system given %
               its input and impulse response.The
               conv() function computes the convolution
               % sum : y(n) =
    x(n) * h(n).% % == == == == == == == == == == == == == == == == == == == ==
    == == == == == == == == == == == == == == == == == ==
    ...
    % Define input sequence x[n] %
        This represents the input signal to the LTI system Xn = [1 3 2 - 1];
