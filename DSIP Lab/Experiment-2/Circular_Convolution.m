...
%
% Experiment No. : 2
% Experiment Title : Linear and Circular Convolution using FFT
%
% Aim:
% Write a program to perform Discrete Convolution such as
...
% -----------------------------
Xn = [0 1 2 3];        % First input sequence
Yn = [1 2 0 -1];       % Second input sequence

% -----------------------------
% FFT of Input Signals
% -----------------------------
x = fft(Xn);           % FFT of first signal
y = fft(Yn);           % FFT of second signal

% -----------------------------
% Convolution in Frequency Domain
% -----------------------------
C = x .* y;            % Point-wise multiplication

% -----------------------------
% Inverse FFT (Circular Convolution)
% -----------------------------
T = ifft(C);           % Circular convolution result
