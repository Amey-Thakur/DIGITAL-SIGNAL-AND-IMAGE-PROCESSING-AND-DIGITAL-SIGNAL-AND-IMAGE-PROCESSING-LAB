% == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == == == ==
    = % DIGITAL SIGNAL AND IMAGE PROCESSING LAB % % Experiment No. : 10 %
              Experiment Title
    : Edge Detection using Sobel and Prewitt Masks %
      % Aim : % Write a program to implement Edge Detection using %
...
% Initialize output images w1 = I;
% Sobel output w2 = I;
% Prewitt output

    % -- -- -- -- -- -- -- -- -- -- -- -- -- -- -% Input Masks %
    -- -- -- -- -- -- -- -- -- -- -- -- -- -- -M1 =
    input('Enter Sobel Mask Matrix : ');
