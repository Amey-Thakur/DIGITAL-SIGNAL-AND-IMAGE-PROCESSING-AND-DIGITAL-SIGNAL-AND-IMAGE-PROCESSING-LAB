...
%
% Experiment No. : 4
% Experiment Title : Discrete Fourier Transform (DFT) of a Sequence
%
% Aim:
% Write a program to find N-point Discrete Fourier Transform (DFT)
...
phase = rad2deg(angle(z));            % Phase spectrum in degrees
